          ...
          Flexible(
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius:
                    BorderRadius.all(Radius.circular(Dimens.contentRadius)),
              ),
              child: RawScrollbar(
                child: SingleChildScrollView(
                  child: Column(
    ...
    return Padding(
      ...
      child: Container(
        decoration: BoxDecoration(
            color: Colors.grey,
            borderRadius: BorderRadius.all(
                Radius.circular(Dimens.compressedTaskListBorderRadius))),
        padding: Dimens.timelineContainerPadding,
        height:
            _getScreenHeight / Dimens.placeHolderCompressedTaskListHeightRatio,
