...
class Dimens {
  ...
  static const taskListProgressBarPadding =
  ...
  static const deadlineContainerPadding =
  ...
  static const compressedTaskListPadding =
  ...
  static const questionDescriptionPadding =
      EdgeInsets.only(left: 23, right: 10, bottom: 10);
  ...
  static const singleTextOptionPadding =
  ...
  static const placeHolderCarouselSliderContainerPadding =
      EdgeInsets.only(top: 20);
  static const placeHolderStepSliderBorderRadius = 20.0;
  static const placeHolderCarouselHeightRatio = 4;
  static const inProgressTextPadding =
      EdgeInsets.only(left: 20, top: 35, bottom: 10);
  static const inProgressTextFont = 18.0;
  static const currentStepIndicatorPadding = EdgeInsets.only(
    top: 30,
    left: 15,
  );
  ...
  static const infoBottomSheetPadding =
      const EdgeInsets.fromLTRB(20, 25, 20, 90);
  static const infoButtonsPadding =
  ...
  static const questionsStepDescMargin =
      const EdgeInsets.only(left: 30, right: 30, top: 12, bottom: 25);
  ...
  static double nextStageSurroundingContainerHeight =
      nextStageDistanceFromBottom + nextStageDefaultHeight + 10;
